<!--TODO : Créer composant enfant : AnimalList.vue, AnimalItem-->
<!--TODO : Corriger gestion et path images-->
<template>
            ...
            <table class="min-w-full bg-white border border-gray-300">
                ...
                <tr v-for="animal in animals" :key="animal['@id']" class="hover:bg-gray-100">
                    ...
                    <td class="px-4 py-2 border-b">
                        <img :src="animal.picture[0].url" :alt="animal.name" class="h-16 w-16 object-cover">
                    </td>
